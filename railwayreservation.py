...
mycursor.execute("use rail")
print(" Creating Traindetails table")
sql = "CREATE TABLE if not exists Traindetails(tname char(50),tnum int(6) primary key,src char(50),des char(50),ac1 int(5),ac2 int(5),ac3i int(5),slp int(5));"
mycursor.execute(sql)
print(" Creating Traindetails table")
sql = "CREATE TABLE  if not exists passangers(pname char(50),age int(5),trainno int(6),noofpass int(4),cls char(4),amt int(6),status char(10),pnrno int(6));"
mycursor.execute(sql)
def railresmenu():
